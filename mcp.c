      ...
      if (strcmp(argv[i], "--help") == 0 || strcmp(argv[i], "-h") == 0)
        {
          ...
          fprintf(stderr, "   --help -h                  Displays a help message.\n");
          fprintf(stderr, "   --version                  Displays version information.\n");
          fprintf(stderr, "   --define -d name[=text]    Defines a define name for all the\n");
          fprintf(stderr, "                              processed files. Such defines cannot\n");
          fprintf(stderr, "                              be undefined.\n");
          fprintf(stderr, "   --non-prefixed -n          Turns non-prefixed expansion on.\n");
          fprintf(stderr, "   --ignore-case -i           Makes mcp case-insensitive. By default\n");
          fprintf(stderr, "                              mcp is case-sensitive.\n");
          fprintf(stderr, "   --                         End of options.\n");
          fprintf(stderr, "\n");
          fprintf(stderr, "You may pass - instead of an input file to indicate standard input.\n");
          return 0;
        }
      else if (strcmp(argv[i], "--version") == 0)
        {
          fprintf(stderr, "mcp 1.0.0\n\n");
